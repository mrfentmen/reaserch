...
1. R004 DONE → 2. R008 FAILED (documented) → 3. R007 DONE → 4. R002 DONE → 5. R009/R005 DONE → 6. R011 ACTIVE-parked (open phenomenon) → 7. R013 FAILED-honorable (falsification exhausted; T closed) → 8. next: R001/R003 methods or R006 (all need new tickets before compute) → 9. R010 (process).
