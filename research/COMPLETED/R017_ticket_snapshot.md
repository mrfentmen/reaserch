...
## R017: THEOREM-HUNT FOR "|off|=1 ⟹ P"

- ID: R017
- QUESTION: Can U (formal proposition R017_001) be proved, reduced, refuted, or precisely explained as unprovable-from-available-conditions?
- KNOWN: phenomenon unfalsified through dataset/2.7M-wide/higher-exp/R013/R015-1000 scopes; mechanisms dead; no covering theorem in bounded survey.
- METHOD: pure-math proposition + U1–U14 decomposition → contrapositive/prime-divisor/factorization/gcd/valuation/parity/exponent attacks → targeted lit (Pillai/Catalan/LRN/taxicab) → tower falsification (powers of two × imbalance, exps beyond hunter).
- SUCCESS CONDITION: proof / generalized lemma / conditional theorem / reduction / verified counterexample / precise unprovability explanation.
- OUTCOME 2026-09-18: no proof (every lever returns "consistent" — documented in R017_002/R017_004 attacks);
  no counterexample (tower 45,878 pairs, 0 hits); proven SUBLEMMAS L2a/L2b (C35) + T-impossibility already C26;
  literature adjacency mapped (sums-of-two-cubes/taxicab explain duplicate namings, not P);
  precise unresolved form stands (option 8, strengthened: every natural divisor lever points AWAY from P).
- STATUS: COMPLETED 2026-09-18 (investigation exhausted per plan; phenomenon OPEN — C19 unchanged by rule).
- NEXT ACTION: done. R011 parked (proof idea or wider scale via new ticket only).
- EVIDENCE: `research/EXPERIMENTS/R017_001_formal_statement.md`, `R017_002_algebraic_attack.md`,
  `R017_004.md` (this cycle's verdict record — see below), `R017_005.md` (baseline/partial),
  `R017_006.md` (opt rerun) + scripts (`R017_005_baseline.py`, `R017_006_tower_opt.py`);
  `research/ARTIFACTS/R011_004_definitions.md`, `R011_004_attacks.md`,
  `R017_005_partial_stdout.txt`, `R017_006_gate.txt`, `R017_006_bench.txt`, `R017_006_stdout.txt`,
  `R017_006_counts.json`; ledger C19/C24/C25/C35/C36.
